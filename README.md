...
- Não consegui terminar os testes de integração a tempo da data combinada. Caso tenham interesse posso continuá-los. Pois há cenários de teste não cobertos cuja a ideia era justamente fazê-lo através dos testes de integração.